                                       ...
                                       withSparql=FALSE)
{
  ...
  download.file("https://github.com/juldebar/IRDTunaAtlas/blob/master/data/gshhs_c_L1.RData?raw=true",destfile="gshhs_c_L1.RData")
  load("gshhs_c_L1.RData")
  ...
  for (species.current in unique(df$species)) {
    ...
    tempfile.base <- paste(filename, sep="")
