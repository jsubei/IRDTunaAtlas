-- View: public.i1i2_spatial_all_datasets

-- DROP MATERIALIZED VIEW public.i1i2_spatial_all_datasets;

CREATE MATERIALIZED VIEW public.i1i2_spatial_all_datasets
...
AS
 SELECT metadata.identifier AS dataset,
  ...
  GROUP BY metadata.identifier, source_labels.codesource_source, geargroup_label.codesource_gear, "time".year, species_labels.codesource_species, unit_labels.codesource_unit, area_labels.geom
WITH DATA;

ALTER TABLE public.i1i2_spatial_all_datasets
    OWNER TO tunaatlas_u;

GRANT ALL ON TABLE public.i1i2_spatial_all_datasets TO tunaatlas_u;
GRANT SELECT ON TABLE public.i1i2_spatial_all_datasets TO tunaatlas_inv;
