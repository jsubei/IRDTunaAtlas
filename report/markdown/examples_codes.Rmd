...
--
<img style="position: absolute; top: 0; right: 0; border: 0;" src="http://mdst-macroes.ird.fr/documentation/databases/Sardara/logos/logo_sardara_cmyk_vector.svg" width="300">
## INDICATOR 1: résultat ggplot
```{r i1_ggplot_result, results = 'hide', tidy = F, message = F}
print(indicator1) 
```
...
---
<img style="position: absolute; top: 0; right: 0; border: 0;" src="http://mdst-macroes.ird.fr/documentation/databases/Sardara/logos/logo_sardara_cmyk_vector.svg" width="300">
## INDICATOR 2: résultat ggplot
```{r i2_ggplot_result, results = 'hide', tidy = F, message = F}
print(indicator2) 
```
...
---
<img style="position: absolute; top: 0; right: 0; border: 0;" src="http://mdst-macroes.ird.fr/documentation/databases/Sardara/logos/logo_sardara_cmyk_vector.svg" width="300">
## INDICATOR 3: résultat ggplot
```{r i3_ggplot_result, results = 'hide', tidy = F, message = F}
print(indicator3) 
```
...
---
<img style="position: absolute; top: 0; right: 0; border: 0;" src="http://mdst-macroes.ird.fr/documentation/databases/Sardara/logos/logo_sardara_cmyk_vector.svg" width="300">
## INDICATOR 4: résultat ggplot
```{r i4_ggplot_result, results = 'hide', tidy = F, message = F}
print(indicator4) 
```
...
---
<img style="position: absolute; top: 0; right: 0; border: 0;" src="http://mdst-macroes.ird.fr/documentation/databases/Sardara/logos/logo_sardara_cmyk_vector.svg" width="300">
## INDICATOR 6: résultat ggplot
```{r i6_ggplot_result, results = 'hide', tidy = F, message = F}
print(indicator6) 
```
...
---
<img style="position: absolute; top: 0; right: 0; border: 0;" src="http://mdst-macroes.ird.fr/documentation/databases/Sardara/logos/logo_sardara_cmyk_vector.svg" width="300">
## INDICATOR 7: résultat ggplot
```{r i7_ggplot_result, results = 'hide', tidy = F, message = F}
print(indicator7) 
```
...
```{r i8_ggplot_result, results = 'hide', tidy = F, message = F}
print(indicator8) 
```
...
---
<img style="position: absolute; top: 0; right: 0; border: 0;" src="http://mdst-macroes.ird.fr/documentation/databases/Sardara/logos/logo_sardara_cmyk_vector.svg" width="300">
## INDICATOR 9: résultat ggplot
```{r i9_ggplot_result, results = 'hide', tidy = F, message = F}
print(indicator9) 
```
...
---
<img style="position: absolute; top: 0; right: 0; border: 0;" src="http://mdst-macroes.ird.fr/documentation/databases/Sardara/logos/logo_sardara_cmyk_vector.svg" width="300">
## INDICATOR 10: résultat ggplot
```{r i10_ggplot_result, results = 'hide', tidy = F, message = F}
print(indicator10) 
```
