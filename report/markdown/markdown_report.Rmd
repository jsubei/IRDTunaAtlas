...
```{r i1_rchart_d3js_result,results = 'asis', comment = NA}
    aggData <-indicator1
...
<img style="position: absolute; top: 0; right: 0; border: 0;" src="http://mdst-macroes.ird.fr/documentation/databases/Sardara/logos/logo_sardara_cmyk_vector.svg" width="300">
## INDICATOR 1: D3JS rCharts result
```{r i1_rchart_d3js_bis_result,results = 'asis', comment = NA}
...
```{r i1_rchart_Rickshaw_result,results = 'asis', comment = NA}
    aggData <-indicator1
    ...
    plotRchartsRickshaw$set(width = 1000, height = 300, legend = TRUE, slider = TRUE)  
