...
[https://github.com/juldebar/IRDTunaAtlas](https://github.com/juldebar/IRDTunaAtlas)
...
df_i3_filtered <- df_i3 %>% filter(gear_type %in% target_gear, species %in% target_species) 
    
Atlas_i3_SpeciesYearByGearMonth(df_i3_filtered, 
                                            yearAttributeName="year", 
                                            monthAttributeName="month", 
                                            speciesAttributeName="species",
                                            gearTypeAttributeName="gear_type",
