...
# df_i6i7i8 <- dbGetQuery(con, query_i6i7i8)
# colnames(df_i6i7i8)
...
resultPlot <- Atlas_i1_SpeciesByOcean(df_i1, 
                         yearAttributeName="year", 
                         oceanAttributeName="ocean", 
                         speciesAttributeName="species", 
                         valueAttributeName="value")
...
target_species <- c("SKJ","BFT")
# target_year <- c("2004")
# df_i6i7i8_filtered <- df_i6i7i8 %>% filter(year %in% target_year, species %in% target_species)

df_i6i7i8_filtered <- df_i6i7i8 %>% filter(year %in% input$year_i3, species %in% target_species) 
