...
# target_species <- "SKJ"
# target_year = 1999
# df_i10_filtered <- df_i9i10 %>% filter(year %in% target_year, species %in% target_species)
df_i10_filtered <- df_i9i10 %>% filter(year %in% input$year_choice_i9i10, species %in% input$species_choice_i9i10)


i10 <-  Atlas_i10_RelativeSizeFrequenciesByDecade(df=df_i10_filtered,
                                                     temporalAgg=5,
                                                     yearAttributeName="year",
                                                     speciesAttributeName="species",
                                                     sizeClassLowerBoundAttributeName="class_low",
